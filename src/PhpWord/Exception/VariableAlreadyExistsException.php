...
/**
 * Description of BlockAlreadyExistsException
 *
 * 
 */
class VariableAlreadyExistsException extends Exception {
     ...
     */
    final public function __construct($variableName, $code = 0, \Exception $previous = null) {
	parent::__construct(
		sprintf('Variable \'%s\' already exists.', $variableName), $code, $previous
	);
    }
